...
fn create_transformation(regs: &opensbi_sys::sbi_trap_regs, previous_mepc: usize) -> Result<ExposeToHypervisor, Error> {
    ...
    Ok(ExposeToHypervisor::SbiResult(SbiResult::with_mstatus(a0, a1, pc_offset)))
}
