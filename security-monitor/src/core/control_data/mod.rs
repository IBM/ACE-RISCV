...
pub const HART_VSIP_OFFSET: usize = hart_csr_offset!(vsip);
...
pub const HART_VSTIMECMP_OFFSET: usize = hart_csr_offset!(vstimecmp);
pub const HART_HTIMEDELTA_OFFSET: usize = hart_csr_offset!(htimedelta);
pub const HART_HVIP_OFFSET: usize = hart_csr_offset!(hvip);
pub const HART_HGEIP_OFFSET: usize = hart_csr_offset!(hgeip);
pub const HART_HIE_OFFSET: usize = hart_csr_offset!(hie);
...
pub const HART_MTVEC_OFFSET: usize = hart_csr_offset!(mtvec);
...
pub const HART_STVEC_OFFSET: usize = hart_csr_offset!(stvec);
