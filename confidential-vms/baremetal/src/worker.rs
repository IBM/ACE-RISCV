...
use crate::{format, trap, trap_handler_asm, Uart, UART_BASE_ADDRESS};
...
extern "C" fn worker_init(hart_id: usize) {
    ...
    sbi::system_reset::system_reset(sbi::system_reset::ResetType::Shutdown, sbi::system_reset::ResetReason::NoReason)
